...
export const bookVisit = asyncHandler(async(req, res) => {
    ...
    try{
        ...
        if(alreadyBooked.bookedVisits.some((visit)=> visit.id === id)){
            res.status(400).json({message: "Visit for this residency is already booked by you"})
        }
        else{
...
// function to cancel booking of a property for a user
export const cancelBooking = asyncHandler(async(req, res) => {
    ...
    try {
        ...
        //  "user" contains the the bookedVisits property of the user
...
// function to add a property to the list of favourites of a user
...
// function to get all favourites of a user
